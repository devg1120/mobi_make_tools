...
function webget4(source_filepath, dist_filepath, values) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        */
        ...
        extract_sections(build_kindlerb_tree);
        yield sleep(9000);
        build_kindlerb_tree();
        /*
...
function extract_sections(aftertask) {
    try {
        ...
        cheerio_httpcli_1.default.fetch(index_url)
            ...
            /*
                   fs.writeFile(output_dir +  '/session.yaml', yamlText, 'utf8', function (err) {
                if (err) {
                    return console.log(err);
                }
            });
            */
            fs_1.default.writeFileSync(output_dir + '/session.yaml', yamlText, 'utf8');
...
function http_get_file(url, save_file_path) {
    ...
    var req = http_1.default.get(options, function (res) {
